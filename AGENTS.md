...
This project is indexed by GitNexus as **Breadcall** (618 symbols, 1765 relationships, 51 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
